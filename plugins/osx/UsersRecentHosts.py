""" Module to extract information from RecentHosts """
import codecs
import logging
import os
...
class UsersRecentHosts(Plugin):
    ...
    def __init__(self):
        ...
        self.set_description("Parse information from /Users/username/Library/Application Support/com.apple.sharedfilelist/com.apple.LSSharedFileList.RecentHosts.sfl")
        self.set_data_file("com.apple.LSSharedFileList.RecentHosts.sfl")
        self.set_output_file("_RecentHosts.txt")
